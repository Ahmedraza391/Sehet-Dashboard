...
if(mysqli_num_rows($check_id)>0){
    ...
    if($update_query){
        ...
        $date = date('Y-m-d');
        $time = date('h:i:s');
        $insert_history = mysqli_query($connection,"INSERT INTO tbl_history (page_name,changes_person,change_type,date,time)VALUES('panels','$c_person','deactivate_panels','$date','$time')");
