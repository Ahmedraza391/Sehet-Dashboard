        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="card p-3">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="card p-3">
                                        ...
                                        <div class="password mb-2 d-md-flex align-items-center justify-content-left">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="edit_user_form">
                                        ...
                                        <input type="hidden" name="edit_user_changes_person" id="edit_user_changes_person" value="<?php echo $changes; ?>" />
                                        <div class="button">
                    ...
                    <!-- View History Modal -->
                    <div class="modal fade" id="view_users_history" tabindex="-1" aria-labelledby="view_users_historyLabel" aria-hidden="true" data-bs-backdrop="static">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title" id="view_users_historyLabel">User History</h3>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="card p-3">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($connection, "SELECT * FROM tbl_history WHERE page_name='users' ORDER BY id DESC");
                                                $index = 1;
                                                if(mysqli_num_rows($query)>0){
                                                    foreach ($query as $history) {
                                                        echo "<tr>";
                                                        $page_name = "";
                                                        if ($history['page_name'] == "users") {
                                                            $page_name = "User";
                                                        }
                                                        echo "<td>{$index}</td>";
                                                        ...
                                                        $type = "";
                                                        if ($history['change_type'] == "add_users") {
                                                            $type = "User Added";
                                                        } else if ($history['change_type'] == "edit_users") {
                                                            $type = "User Edited";
                                                        } else if ($history['change_type'] == "available_users") {
                                                            $type = "User Available";
                                                        } else if ($history['change_type'] == "unavailable_users") {
                                                            $type = "User Unavailable";
                                                        } else if ($history['change_type'] == "enable_users") {
                                                            $type = "User Enable";
                                                        } else if ($history['change_type'] == "disable_users") {
                                                            $type = "User Disable";
                                                        } else if ($history['change_type'] == "activate_users") {
                                                            $type = "User Activate";
                                                        } else if ($history['change_type'] == "deactivate_users") {
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-2 mb-sm-3 mb-md-0 col-md-4 d-md-flex align-items-center justify-content-start">
                            <button type="button" class="btn btn-primary btn-sm text-center" data-bs-toggle="modal" data-bs-target="#add_user">
                                Add Users
                            </button>
                        </div>
                        <div class="col-md-4"></div>
                        <div class="col-sm-12 mb-2 mb-sm-3 mb-md-0 col-md-4 d-md-flex align-items-center justify-content-end">
                            <button type="button" class="btn btn-success btn-sm text-center" data-bs-toggle="modal" data-bs-target="#view_users_history">
                                View Users History
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="employee_user_form">
                                            <form id="insert_user_form">
                                                <input type="hidden" value="emp_user_id" name="emp_user_id" id="emp_user_id">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="emp_user_name" name="emp_user_name" placeholder="" required>
                                                    <label for="emp_name">User Name</label>
                                                    <div class="invalid-feedback emp_name_feedback">Please enter the User Name.</div>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="emp_user_father_name" name="emp_user_father_name" placeholder="" required>
                                                ...
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="emp_email">User Email</label>
                                                    <div class="invalid-feedback emp_emai_feedback">Please enter a valid email address.</div>
                                                </div>
                                                <div class="form-floating mb-3 password-wrapper">
                                                    ...
                                                    <i class="bi bi-eye-slash togglePassword"></i>
                                                    <label for="emp_user_password">User Password</label>
                                                    <div class="invalid-feedback">Please, Enter password!</div>
                                                </div>
                                                <div class="form-floating mb-3">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="emp_user_nic" name="emp_user_nic" placeholder="" pattern="\d{13}" required>
                                                    <label for="emp_nic">User N.I.C #</label>
                                                    <div class="invalid-feedback emp_nic_feedback">Please enter a valid NIC number with exactly 13 digits.</div>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input type="date" class="form-control" id="emp_user_dob" name="emp_user_dob" placeholder="" max="<?php echo date('Y-m-d', strtotime('-1 day')); ?>" required>
                                                    <label for="emp_dob">User Date Of Birth</label>
                                                    <div class="invalid-feedback emp_dob_feedback">Please select a date of birth from previous years only.</div>
                                                </div>
                                                <div class="card p-md-3">
                                                    <label class="mb-3">Select Pages :</label>
                                                ...
                                                <input type="hidden" name="add_user_changes_person" id="add_user_changes_person" value="<?php echo $changes; ?>" />
                                                <div class="button">
