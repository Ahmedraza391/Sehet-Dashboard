...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result) {
        ...
        $date = date('Y-m-d');
        $time = date('h:i:s');
        $insert_history = mysqli_query($connection,"INSERT INTO tbl_history (page_name,changes_person,change_type,date,time)VALUES('service_main_head','$_POST[edit_service_main_changes_person]','edit_service_main_head','$date','$time')");
