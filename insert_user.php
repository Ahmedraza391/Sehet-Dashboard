<?php
    ...
    $insert_query = "INSERT INTO tbl_users (user_name, user_father_name, user_email, user_password, user_contact, user_nic, user_dob, pages_access) VALUES ('$name', '$father_name', '$email', '$password', '$contact', '$nic', '$dob', '$access_pages')";
